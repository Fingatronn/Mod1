...
public class DistillationTankUpdateTickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(new BlockPos(x, y + 1, z))).getBlock() == (world.getBlockState(new BlockPos(x, y, z))).getBlock()
				&& (world.getBlockState(new BlockPos(x, y + 2, z))).getBlock() == (world.getBlockState(new BlockPos(x, y, z))).getBlock() && (world.getBlockState(new BlockPos(x, y - 1, z))).getBlock() == ProbModBlocks.DISTILLER_DOWN.get()
